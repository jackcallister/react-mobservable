...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Cart = __webpack_require__(348);
	...
	document.addEventListener('DOMContentLoaded', function () {
	  (0, _reactDom.render)(_react2.default.createElement(_Cart2.default, null), document.getElementById('app'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mobservableReact = __webpack_require__(349);

	var _UploaderController = __webpack_require__(363);

	var _UploaderController2 = _interopRequireDefault(_UploaderController);

	var _ItemsController = __webpack_require__(367);
	  ...
	  _createClass(Cart, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'section',
	        null,
	        _react2.default.createElement(_UploaderController2.default, null),
	        _react2.default.createElement(_ItemsController2.default, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dnode_1 = __webpack_require__(352);
	var utils_1 = __webpack_require__(357);
	var extras_1 = __webpack_require__(353);
	var simpleeventemitter_1 = __webpack_require__(356);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dnode_1 = __webpack_require__(352);
	var utils_1 = __webpack_require__(357);
	var observablevalue_1 = __webpack_require__(359);
	var observableview_1 = __webpack_require__(355);
	var observablearray_1 = __webpack_require__(358);
	var observableobject_1 = __webpack_require__(354);
	var observablemap_1 = __webpack_require__(360);
	var dnode_2 = __webpack_require__(352);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uploader = __webpack_require__(364);

	var _Uploader = __webpack_require__(366);
	...
	var UploaderController = function (_Component) {
	  _inherits(UploaderController, _Component);

	  function UploaderController() {
	    _classCallCheck(this, UploaderController);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(UploaderController).apply(this, arguments));
	  }

	  _createClass(UploaderController, [{
	    key: 'render',
	    value: function render() {
	      var props = _extends({
	        beginUploadingFile: _uploader.beginUploadingFile
	      }, _store2.default.uploader);

	      return _react2.default.createElement(_Uploader2.default, props);
	    }
	  }]);
	...
	exports.default = (0, _mobservableReact.observer)(UploaderController);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.beginUploadingFile = beginUploadingFile;

	var _uploader = __webpack_require__(365);

	var WebUtils = _interopRequireWildcard(_uploader);
	...
	function onProgress(completion) {
	  _store2.default.uploader.completion = completion;
	}

	function beginUploadingFile(path) {
	  _store2.default.uploader.status = 'UPLOADING';

	  WebUtils.upload(path, onProgress.bind(this)).then(function (item) {
	    _store2.default.uploader.status = 'EMPTY';
	    _store2.default.uploader.completion = 0;
	    _store2.default.items = _extends({}, _store2.default.items, _defineProperty({}, item.id, item));
	  });
	}
...
/***/ function(module, exports) {
	...
	function upload(path, onProgress) {
	  var completion = 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Uploader = function (_Component) {
	  ...
	  _createClass(Uploader, [{
	    key: 'onBeginUploadingFile',
	    value: function onBeginUploadingFile() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Items = __webpack_require__(368);
	...
	var ItemsController = function (_Component) {
	  _inherits(ItemsController, _Component);

	  function ItemsController() {
	    _classCallCheck(this, ItemsController);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ItemsController).apply(this, arguments));
	  }
	  ...
	  _createClass(ItemsController, [{
	    ...
	    value: function render() {
	      var props = {
	        items: Object.keys(_store2.default.items).map(function (k) {
	          return _store2.default.items[k];
	        })
	      };

	      return _react2.default.createElement(_Items2.default, props);
	    }
	  }]);
	...
	exports.default = (0, _mobservableReact.observer)(ItemsController);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ItemController = __webpack_require__(369);
	  ...
	  _createClass(Items, [{
	    ...
	    value: function renderItems() {
	      return this.props.items.map(function (item) {
	        return _react2.default.createElement(_ItemController2.default, { key: item.id, item: item });
	      });
	    }
	  }, {
	    key: 'render',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Item = __webpack_require__(404);
	...
	var ItemController = function (_Component) {
	  _inherits(ItemController, _Component);

	  function ItemController() {
	    _classCallCheck(this, ItemController);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ItemController).apply(this, arguments));
	  }
	  ...
	  _createClass(ItemController, [{
	    ...
	    value: function render() {
	      var props = _extends({
	        changeItemAmount: _item.changeItemAmount,
	        deleteItem: _item.deleteItem
	      }, this.props.item);
	...
	exports.default = (0, _mobservableReact.observer)(ItemController);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.changeItemAmount = changeItemAmount;
	exports.deleteItem = deleteItem;

	var _omit = __webpack_require__(371);
	...
	function changeItemAmount(id, amount) {
	  _store2.default.items[id].amount = amount;
	}

	function deleteItem(id) {
	  _store2.default.items = (0, _omit2.default)(_store2.default.items, id);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayMap = __webpack_require__(372),
	    baseDifference = __webpack_require__(373),
	    baseFlatten = __webpack_require__(385),
	    bindCallback = __webpack_require__(393),
	    keysIn = __webpack_require__(395),
	    pickByArray = __webpack_require__(397),
	    pickByCallback = __webpack_require__(399),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIndexOf = __webpack_require__(374),
	    cacheIndexOf = __webpack_require__(376),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexOfNaN = __webpack_require__(375);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var SetCache = __webpack_require__(379),
	    getNative = __webpack_require__(381);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var cachePush = __webpack_require__(380),
	    getNative = __webpack_require__(381);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isNative = __webpack_require__(382);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseForIn = __webpack_require__(400);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Item = function (_Component) {
	  ...
	  _createClass(Item, [{
	    key: 'onChangeItemAmount',
	    value: function onChangeItemAmount() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mobservable = __webpack_require__(350);

	exports.default = (0, _mobservable.observable)({
	  uploader: {
	    status: 'EMPTY',
	    completion: 0,
	    path: ''
